...
├── analysis/              # 分析レポート
│   └── tiktok-decline-analysis.md  # TikTok再生数低下分析（2025/10〜2026/1）
...
| ファイル | 用途 |
|---------|------|
| `analysis/tiktok-decline-analysis.md` | TikTok再生数低下アカウント別分析（2025/10〜2026/1、756件） |
...
- 2026-01-28: analysis/フォルダ追加（TikTok再生数低下アカウント別分析、756件、-86%原因特定）
