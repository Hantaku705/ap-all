  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#f8f9fa]">
        {/* Promotional Banner - anystarr style */}
        {showBanner && (
          <div className="relative bg-gradient-to-r from-[#ff6b6b] to-[#ff8e53] px-4 py-3 text-center text-white">
            <div className="mx-auto flex max-w-7xl items-center justify-center gap-4">
              <span className="text-sm font-medium">
                ✨ 今すぐ登録で初回サンプル無料！業界最高水準のコミッション率で稼ごう
              </span>
              <Link
                href="/register"
                className="rounded-full bg-white px-4 py-1 text-sm font-medium text-[#ff6b6b] transition-colors hover:bg-gray-100"
              >
                登録する
              </Link>
            </div>
